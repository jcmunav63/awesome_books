...
# 📖 [AWESOME BOOKS - A Book's Webpage (HTML & JAVASCRIPT).] <a name="about-project"></a>

**AWESOME BOOKS Webpage** It's a webpage to show a list of books, using plain JavaScript & Objects.
...
```sh
  ...
  git clone git@github.com:jcmunav63/awesome_books.git
```
...
- LinkedIn: [@juan-carlos-muñoz-navarrete](https://www.linkedin.com/in/)
<p align="right">(<a href="#readme-top">back to top</a>)</p>
